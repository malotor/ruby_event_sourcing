RSpec.describe SimpleEventSourcing::AggregateRoot::Base do
  ...
  def reconstruct_from_history(id)
    aggregate_id = SimpleEventSourcing::Id::UUIDId.new id
  ...
  it 'is reconstructed by a events history' do
    aggregate = reconstruct_from_history '4bb20d71-3002-42ea-9387-38d6838a2cb7'
  ...
  it 'reconstructed aggregate' do
    aggregate = reconstruct_from_history '4bb20d71-3002-42ea-9387-38d6838a2cb7'

    aggregate.a_method(60, 70)
    expect(aggregate.a_field).to eq(60)
    expect(aggregate.other_field).to eq(70)
  end
end
